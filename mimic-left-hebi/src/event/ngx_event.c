...
static ngx_atomic_t   ngx_mimic_requests0;
ngx_atomic_t         *ngx_mimic_requests = &ngx_mimic_requests0;
#else
ngx_uint_t ngx_mimic_requests;
#endif
...
#if (!NGX_MIMIC_REQUESTS_WORKER)
    ngx_mimic_requests = (ngx_atomic_t *) (shared + 10 * cl);
#endif
