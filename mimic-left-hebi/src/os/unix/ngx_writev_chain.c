...
ngx_writev_chain(ngx_connection_t *c, ngx_chain_t *in, off_t limit)
{
    ...
    ngx_log_error(NGX_LOG_ALERT, c->log, 0,"****ngx_writev_chain");
...
eintr:
    ...
    ngx_log_debug2(NGX_LOG_DEBUG_EVENT, c->log, 0,
                   "writev-------writev-------writev-------writev-------writev-------: %z of %uz", n, vec->size);
    ...
    // if(c->get_body_flag){
    //     c->send_len += n;
    //     ngx_log_debug1(NGX_LOG_DEBUG_EVENT, c->log, 0,"r  writev length=%l",c->send_len);
    // }
